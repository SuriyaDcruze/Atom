      ...
      <div className="max-w-7xl mx-auto">
        ...
        {services.length === 0 && (
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900">No completed services this month</h3>
            <p className="text-gray-500 mt-1">All services are either pending or overdue</p>
          </div>
        )}
      </div>
    </div>
...
export default ThisMonthCompleted;