  ...
  return (
    <div className="container mx-auto p-4 bg-gray-50 min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-center mb-6">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-0">This month expire AMC</h2>
          ...
          <tbody>
            {mockData.map((item, index) => (
              <tr key={index} className="hover:bg-gray-50 transition duration-300">
                ...
                <td className="py-2 px-4 border-b border-gray-200 flex flex-col items-center space-y-2">
