      ...
      <div className="max-w-7xl mx-auto">
        ...
        {services.length === 0 && (
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900">No services scheduled for {selectedMonth}</h3>
            <p className="text-gray-500 mt-1">Try selecting a different month or check back later</p>
          </div>
        )}
      </div>
    </div>
...
export default LastMonthServices;